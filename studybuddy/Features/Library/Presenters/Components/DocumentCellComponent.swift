...
struct DocumentCellComponent: View {
    var data: Library
    var body: some View {
        HStack(spacing: 15) {
...
struct DocumentCellComponent_Previews: PreviewProvider {
    static var previews: some View {
        DocumentCellComponent(data: Library(id: UUID().uuidString, url: "TEST", dateCreated: Date(), type: "image", user: ""))
    }
}
